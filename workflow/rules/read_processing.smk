...
rule map_to_human_genome:
    message:
        "Mapping reads to the human genome to remove human contaminants"
    conda:
        "../envs/read_processing.yaml"
    # container: "docker://quay.io/biocontainers/bwa:0.7.17--h5bf99c6_8"
    log:
...
rule extract_unmapped_reads:
    message:
        "Extracting unmapped reads from bam file"
    conda:
        "../envs/read_processing.yaml"
...
rule bamtoFastq:
    message:
        "Converting BAM file into fastq files of forward and reverse reads"
    conda:
        "../envs/read_processing.yaml"
    # container: "docker://quay.io/biocontainers/samtools:1.12--h9aed4be_1"
    log:
